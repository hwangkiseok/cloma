<div class="container-fluid">
    <div class="row">
        <h4 class="page-header">게시물관리 > 목록</h4>
    </div>
    ...
    <div class="row">
        <form name="search_form" id="search_form" method="post" action="<?php echo $this->page_link->list_ajax; ?>" class="form-horizontal">
            ...
            <div class="form-group form-group-sm">
                <label class="col-sm-2 control-label" for="div">게시판선택</label>
                <div class="col-sm-10">
            ...
            <div class="form-group form-group-sm">
                <label class="col-sm-2 control-label" for="top_yn">상위노출</label>
                <div class="col-sm-10">
                    <select id="top_yn" name="top_yn" class="form-control" style="width:auto;">
                        <?php echo get_select_option("* 선택 *", $this->config->item("board_help_top_yn"), $req['top_yn']); ?>
                    </select>
                </div>
            </div>
            <div class="form-group form-group-sm">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn" style="width:auto">
                            <select id="kfd" name="kfd" class="form-control" style="border-bottom-left-radius:3px;border-top-left-radius:3px;">
                                <option value="bh_subject">제목</option>
                                <option value="bh_content">내용</option>
                            </select>
                        </span>
            ...
            <div class="form-group form-group-sm text-center">
                ...
                <button type="button" class="btn btn-info btn-sm mgl10" onclick="board_help_insert_pop();" style="width:100px;">등록</button>
...
<script>
     ...
     * 게시물 수정 팝업
     */
    function board_help_update_pop(bh_num) {
        var container = $('<div>');
        $(container).load('<?php echo $this->page_link->update_pop; ?>/?bh_num=' + bh_num);

        modalPop.createPop('게시물 수정', container);
     ...
     * 게시물 삭제
     */
    function board_help_delete(bh_num) {
        if( !confirm('삭제하시겠습니까?') ) {
            return false;
        }
