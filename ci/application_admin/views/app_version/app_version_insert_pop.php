                ...
                <div class="box-content">
                    <form name="pop_insert_form" id="pop_insert_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->insert_proc; ?>">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_os_type">
                                    <?php echo get_input_radio('av_os_type', $this->config->item('app_version_os_type'), 1); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_version">
                                    <input type="text" class="form-control" name="av_version" maxlength="50" />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_version">
                                    <input type="text" class="form-control" name="av_version_code" maxlength="10" />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_offer_type">
                                    <?php echo get_input_radio('av_offer_type', $this->config->item('app_version_offer_type'), 1); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_download_url">
                                    <input type="text" class="form-control" name="av_download_url" maxlength="200" />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_av_content">
                                    <textarea class="form-control" rows="8" name="av_content"></textarea>
                                </div>
                            </div>
                        </div>
