    ...
    <table class="table table-hover" style="margin-top: 64px">
        ...
        <? foreach ($aProductOptionList as $k => $r) { ?>
            ...
            <tr class="update">
                ...
                <td><input type="text" name="option_2[]" value="<?=$r['option_2']?>" class="form-control"  /></td>
                <td><input type="text" name="option_3[]" value="<?=$r['option_3']?>" class="form-control"  /></td>
        ...
        <tr class="insert">
            ...
            <td><input type="text" name="option_2[]" value="" class="form-control"  /></td>
            <td><input type="text" name="option_3[]" value="" class="form-control"  /></td>
...
<script>
    $(function(){
        ...
        add_html += '<td><input type="text" name="option_2[]" value="" class="form-control"  /></td>';
        add_html += '<td><input type="text" name="option_3[]" value="" class="form-control"  /></td>';
