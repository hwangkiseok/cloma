            ...
            <div class="box">
                <div class="box-content">
                    ...
                    <form name="main_form" id="main_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->update_proc; ?>">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_p_ab_test">
                                    <input type="radio" id="p_ab_test_1" name="p_ab_test" value="Y" checked="checked">
                                    <label for="p_ab_test_1">사용</label>&nbsp;&nbsp;
                                    <input type="radio" id="p_ab_test_2" name="p_ab_test" value="N">
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-sm-2 control-label">AB 테스트 타입 <span class="txt-danger">*</span></label>
                            <div class="col-sm-8">
                                <div id="field_p_ab_test_type">
                                    <input type="radio" id="p_ab_test_type_1" name="p_ab_test_type" value="A" <?=$product_row->p_ab_test_type=='A'?'checked':''?>><label for="p_ab_test_type_1">타입1</label>&nbsp;&nbsp;
                                    <input type="radio" id="p_ab_test_type_2" name="p_ab_test_type" value="B" <?=$product_row->p_ab_test_type=='B'?'checked':''?>><label for="p_ab_test_type_2">타입2</label>&nbsp;&nbsp;
                                    <input type="radio" id="p_ab_test_type_3" name="p_ab_test_type" value="C" <?=$product_row->p_ab_test_type=='C'?'checked':''?>><label for="p_ab_test_type_3">타입3</label>
                                </div>
                            </div>
                        </div>

                        <div class="form-group form-group-sm">
                            <label class="col-sm-2 control-label">AB 테스트 코멘트</label>
                            <div class="col-sm-8">
                                <div id="field_p_ab_test_cmt">
                                    <textarea class="form-control"  name="p_ab_test_cmt"><?php echo $product_row->p_ab_test_cmt?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group form-group-sm">
                                <div class="col-sm-12">
                                    <p class="alert alert-warning text-center">Set A</p>
                                </div>
                            </div>
                                    ...
                                    <div class="mgt10" id="field_p_detail_image">
                                        ...
                                        <div class="mgt10 mgb10" id="detail_image_list" style="border:1px solid #ccc;border-radius:4px;padding:10px;width:100%;overflow:auto;">
                                            ...
                                            foreach ( $product_detail_image_array as $key => $item ) {
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 mgt10 text-center list-item" style="" data-key="<?php echo $key; ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-group-sm">
                                    <div class="col-sm-12">
                                        <p class="alert alert-info text-center">Set B</p>
                                    </div>
                                </div>

                                <div class="form-group form-group-sm">
                                    <label class="col-sm-2 control-label">B 상품명 <span class="txt-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="field_p_name_b" name="p_name_b" class="form-control" value="<?php echo $product_row->p_name_b; ?>" />
                                    </div>
                                </div>

                                <div class="form-group form-group-sm" style="height: 60px;">
                                    <!--간략설명-->
                                </div>

                                <div class="form-group form-group-sm">
                                    <label class="col-sm-2 control-label">B 상세설명</label>
                                    <div class="col-sm-10">
                                        <textarea id="field_p_detail_b" name="p_detail_b" style="width:100%; height:200px; display:none;"><?php echo $product_row->p_detail_b; ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group form-group-sm" style="height: 30px;">
                                    <!--공구폼상품코드 -->
                                </div>
                                <hr/>

                                <div class="form-group form-group-sm" style="height: 615px;">
                                </div>

                                <div class="form-group form-group-sm" style="height: 30px;">
                                    <label class="col-sm-2 control-label">B 상품이미지</label>

                                    <div class="col-sm-10">
                                        <div class="input-group" id="field_p_rep_image" style="width:100%;">
                                            <span class="input-group-addon" style="width:110px;">B 대표이미지 <span class="txt-danger">*</span></span>
                                            <input type="file" name="p_rep_image_b" class="form-control" accept="image/*" />
                                        </div>
                                        <?php if( $this->config->item('product_rep_image_size') ) { ?>
                                            <p class="help-block">*
                                                <?php foreach ($this->config->item('product_rep_image_size') as $item) { ?>
                                        ...
                                        <?if($product_row->p_rep_image_b){?>
                                            <div class="mgt5 mgb10" style="margin-bottom: 315px">
                                                <?php echo create_img_tag_from_json($product_row->p_rep_image_b, 1, '100', '', 'data-type="rep_img"'); ?>
                                            </div>
                                        <?}else{?>
                                            <div class="mgt5 mgb10" style="margin-bottom: 385px">
                                            </div>
                                        <?}?>
                                        <!--
                                        <div class="input-group mgt10" id="field_p_today_image" style="width:100%;">
                                        ...
                                        <div class="input-group mgt10" id="field_p_banner_image" style="width:100%;">
                                            <span class="input-group-addon" style="width:110px">B 배너이미지</span>
                                            <input type="file" name="p_banner_image" class="form-control" />
                                        </div>
                                        <p class="help-block">* 720 x 300</p>
                                        <div class="mgt5 mgb10 pBannerImage">
                                        ...
                                        <div class="mgt10" id="field_p_detail_image">
                                            <div class="input-group" style="width:100%;">
                                                <span class="input-group-addon" style="width:110px">상세이미지</span>
                                                <input type="file" name="p_detail_image_b[]" class="form-control" multiple="multiple" accept="image/*" />
                                            </div>
                                            <p class="help-block">* 다중 선택 가능 / 이미지 파일(JPG, PNG, GIF)만 가능 / 최대 <?php echo $this->config->item('product_detail_image_max_count'); ?>개, 단일 파일 용량 10MB 미만, 총 용량 100MB 미만 업로드 가능</p>


                                            <?if(count($product_detail_image_b_array) > 0){?>

                                            <p class="text-center"><button type="button" onclick="delete_product_image_b('<?php echo $product_row->p_num; ?>', '3', '');" class="btn btn-danger btn-xs">모두삭제</button></p>
                                            <div class="mgt10 mgb10" id="detail_image_b_list" style="border:1px solid #ccc;border-radius:4px;padding:10px;width:100%;overflow:auto;">

                                                <?php
                                                foreach ( $product_detail_image_b_array as $key => $item ) {
                                                    $img_thumb = $item[1];
                                                    $img_org = $item[0];
                                                    ?>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 mgt10 text-center list-item" style="" data-key="<?php echo $key; ?>">
                                                        ...
                                                        <a href="#none" style="font-size:20px;"><i class="fa fa-sort"></i></a>
                                                        <img src="<?php echo $img_thumb; ?>?t=<?=@filemtime(DOCROOT . $img_thumb);?>" style="width:200px;" alt="" />
                                                        <a href="#none" onclick="delete_product_image_b('<?php echo $product_row->p_num; ?>', '2', this);" class="btn btn-danger btn-xs">삭제</a>
                                                    </div>
                                            ...
                                            <p class="text-center"><button type="button" onclick="delete_product_image_b('<?php echo $product_row->p_num; ?>', '3', '');" class="btn btn-danger btn-xs mgt10">모두삭제</button></p>
                                            <?}?>
                                        </div>
    ...
    $(function(){
        ...
        $(function(){
            nhn.husky.EZCreator.createInIFrame({
                oAppRef: oEditors,
                elPlaceHolder: "field_p_detail_b",
                ...
                fOnAppLoad : function(){
//                oEditors.getById["field_p_detail"].exec("PASTE_HTML", ['<p style="font-family:Noto Sans;font-size:1em;"></p>']);
//                oEditors.getById["field_p_detail"].setDefaultFont("Noto Sans", "1em");
                },
        ...
        $('input[name="p_ab_test"]').on('change',function(e){
            var cf = confirm('현재상품을 AB테스트 상품에서 취소하시겠습니까 ?');
            if(cf){
                var none_test_url = '<?=str_replace('update_ab','update',$_SERVER['REQUEST_URI'])?>  ';
                location.href = none_test_url;
            }else{
                $(this).prop( "checked", false );
                $('input[name="p_ab_test"][value="Y"]').prop( "checked", true );
            }
        });
        ...
        //sortable
        $('#detail_image_b_list').sortable({
            revert: true,
            stop : function(event, ui){
                detail_img_b_order_update(p_num);
            }
        });
        $('#detail_image_b_list').disableSelection();
