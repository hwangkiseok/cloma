            ...
            <div class="box">
                <div class="box-content">
                    <form name="pop_form" id="pop_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->update_proc; ?>">
                        <input type="hidden" name="kp_num" value="<?=$kakao_product_row->kp_num;?>" />
                        ...
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_product_num">
                                ...
                                <input type="text" class="form-control" name="p_name" maxlength="100" style="width:100%;" readonly placeholder="상품검색 후 선택하세요." value="<?=$kakao_product_row->p_name;?>" />
                            </div>
                            <input type="hidden" name="kp_product_num" value="<?=$kakao_product_row->kp_product_num;?>" /><!-- 상품번호 -->
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_prod_type">
                                ...
                                <span class="form-control">
                                    <?=get_input_radio("kp_prod_type", $this->config->item("kakao_product_prod_type"), $kakao_product_row->kp_prod_type);?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_seq">
                                ...
                                <input type="text" class="form-control" name="kp_seq" maxlength="3" style="width:100%;" value="<?=$kakao_product_row->kp_seq;?>" />
                            </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_title">
                                ...
                                <input type="text" class="form-control" name="kp_title" maxlength="100" style="width:100%;" value="<?=$kakao_product_row->kp_title;?>" />
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_content">
                                <span class="input-group-addon" style="width:110px;">내용</span>
                                <textarea class="form-control" name="kp_content" style="height:50px;"><?=$kakao_product_row->kp_content;?></textarea>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_button_name">
                                <span class="input-group-addon" style="width:110px;">버튼명</span>
                                <input type="text" class="form-control" name="kp_button_name" maxlength="100" style="width:100%;" value="<?=$kakao_product_row->kp_button_name;?>" />
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_kp_display_state">
                                ...
                                <span class="form-control">
                                    <?=get_input_radio("kp_display_state", $this->config->item("kakao_product_display_state"), $kakao_product_row->kp_display_state, $this->config->item("kakao_product_display_state_text_color"));?>
                                </span>
                            </div>
                        </div>
                    </form>
