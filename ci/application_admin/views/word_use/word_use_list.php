<div class="container-fluid">
    <div class="row">
        <h4 class="page-header">자주 사용하는 문구 > 목록</h4>
    </div>
    ...
    <div class="row">
        <form name="search_form" id="search_form" method="post" action="<?php echo $this->page_link->list_ajax; ?>" class="form-horizontal">
            ...
            <div class="form-group form-group-sm">
                <label class="col-sm-2 control-label" for="wd_use">검색분류</label>
                <div class="col-sm-10 form-inline">
                    <div class="input-group">
                        <span class="input-group-btn" style="width:auto">
                            <select id="wd_use" name="wd_use" class="form-control" style="border-bottom-left-radius:3px;border-top-left-radius:3px;">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn" style="width:auto">
                            <select id="wd_view" name="wd_view" class="form-control" style="width:auto;">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn" style="width:auto">
                            <select id="kfd" name="kfd" class="form-control" style="border-bottom-left-radius:3px;border-top-left-radius:3px;">
                                ...
                                <option value="wd_subject">제목</option>
                                <option value="wd_content">문구</option>
                            </select>
                        </span>
            ...
            <div class="form-group form-group-sm text-center">
                ...
                <button type="button" class="btn btn-info btn-sm mgl10" onclick="word_use_insert_pop();" style="width:100px;">등록</button>
            </div>
        </form>
    </div>
    ...
    <div class="row">
        ...
        <div id="word_use_list" style="position:relative;"></div>
    </div>
</div>
...
<script>
    ...
    function word_use_update_pop(wd_num) {
        var container = $('<div>');
        $(container).load('/word_use/update_pop/?wd_num=' + wd_num);

        modalPop.createPop('문구 수정', container);
     ...
     * 문구 삭제
     */
    function word_use_delete(wd_num) {
        if( !confirm('삭제하시겠습니까?') ) {
            return false;
        }
    ...
    $(function () {
        ...
        $('#search_form').ajaxForm({
            ...
            beforeSubmit: function(formData, jqForm, options) {
                loadingBar.show($('#word_use_list'));
            },
            success: function(result) {
                $('#word_use_list').html(result);
            },
            complete: function() {
                loadingBar.hide();
            }
        ...
        //ajax page
        $(document).on('click', '#word_use_list .pagination.ajax a', function(e){
            e.preventDefault();
