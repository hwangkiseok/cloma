            ...
            <div class="box">
                <div class="box-content">
                    <form name="pop_update_form" id="pop_update_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->update_proc; ?>">
                        <input type="hidden" name="cm_num" value="<?php echo $common_row->cm_num; ?>" />
                            ...
                            <div class="col-sm-10">
                                <div id="field_cm_code">
                                    <select name="cm_code" class="form-control" style="width:auto;">
                                        <?php echo get_select_option('', $this->config->item('common_code'), $common_row->cm_code); ?>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_cm_usestate">
                                    <?php echo get_input_radio('cm_usestate', $this->config->item('common_usestate'), $common_row->cm_usestate); ?>
                                </div>
                            </div>
                        </div>


                        <div class="form-group form-group-sm" style="<?if($common_row->cm_code == 3){?>display: none;<?}?>">
                            <div id="field_cm_content">
                                <textarea name="cm_content" id="cm_content" style="width:100%; height:200px; visibility:hidden;"><?php echo $common_row->cm_content; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm" style="<?if($common_row->cm_code != 3){?>display: none;<?}?>">
                            <label class="col-sm-2 control-label">구분 <span class="txt-danger">*</span></label>
                            <div class="col-sm-10">
                                <div id="field_cm_content_yn">
                                    <?php echo get_input_radio('cm_content_yn', $this->config->item('product_info_tab_view'), $common_row->cm_content, $this->config->item('product_info_tab_view_text_color')); ?>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(function(){
        ...
        $('input[name="cm_content_yn"]').on('change',function(){
            $('#cm_content').val($(this).val());
        });
