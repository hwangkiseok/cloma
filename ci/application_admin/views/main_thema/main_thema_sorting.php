...
<div class="container-fluid">
    <div class="row">
        <h4 class="page-header">상품관리 &gt; 메인테마 순서 변경</h4>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-content">
                    ...
                    <form name="main_form" id="main_form" method="post" class="form-horizontal" role="form" action="/main_thema/set_sorting">

                        <div class="form-group form-group-sm">
                            <h5 class="col-sm-12">메인테마 순서 변경</h5>
                            <div class="col-sm-12">
                                <div class="mgt10 mgb10" id="detail_image_list" style="border:1px solid #ccc;border-radius:4px;padding:10px;width:100%;overflow:auto;min-height: 300px;">
                                    ...
                                    <?
                                    if(count($main_thema_lists) > 0){
                                        foreach ($main_thema_lists as $key => $row) {
                                    ?>
