        ...
        foreach($app_popup_list as $row) {
            ...
            <tr role="row">
                ...
                <td style="width:100px;">
                    ...
                    <div style="padding: 2px;"></div>
                    <div style="border: 1px solid #d5d5d5; list-style: none; text-align:center; ">
                        <li style="float:left; padding: 2px 0px 0px 5px;">닫기: <?php echo $per_close . "%"; ?> (<?php echo $row->apo_close_count > 0 ? number_format($row->apo_close_count) : '0'; ?> 건)</li>
                        <li class="chart" style="width:<?php echo $per_close; ?>%; height:20px; background-color: #FFA7A7;"></li>
                    </div>
                    -->
                </td>
                <td style="width:60px;">
