...
<div class="container-fluid">
    <div class="row">
        <h4 class="page-header">리뷰 > 목록(TEST)</h4>
    </div>

    <form name="search_form" id="search_form" method="post" action="<?php echo $this->page_link->list_ajax_dev; ?>" class="form-horizontal">
...
-->
            ...
            <div class="pull-left" style="padding-left: 20px;">
                <input type="radio" name="sel_reward_type" checked value="3">텍스트&nbsp;&nbsp;
                <input type="radio" name="sel_reward_type" value="4">이미지&nbsp;&nbsp;&nbsp;
                <button type="button" id="apply_point" class="btn btn-primary btn-xs" style="width:110px;" onclick="batch_apply_point();">적립금 일괄적용</button>
            </div>
...
<script>
    ...
    // 적립금 삭제
    function delete_rel_point(m_key, re_num) {
        $.ajax({
            url: '/point/deleteReviewPointMember/',
            data: { m_key : m_key, re_num : re_num },
            type: 'post',
            dataType: 'json',
            cache: false,
            success: function (result) {
