        ...
        <div class="row" id="search_wrap">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="radio" id="reward_type" name="reward_type" value="A"><label for="reward_typeA">텍스트</label>&nbsp;&nbsp;
                    <input type="radio" id="reward_type" name="reward_type" value="B"><label for="reward_typeB">포토</label>&nbsp;
                    <input type="radio" id="reward_type" name="reward_type" value="C"><label for="reward_typeC">지급안함</label>&nbsp;
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="radio" id="reward_yn" name="reward_yn" value="Y"><label for="reward_Y">지급</label>&nbsp;&nbsp;
                    <input type="radio" id="reward_yn" name="reward_yn" value="N"><label for="reward_N">미지급</label>&nbsp;
                </div>
