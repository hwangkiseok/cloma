                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_apo_os_type">
                                    <input type="hidden" name="apo_os_type" value="1" />
                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_ap_noti_type">
                                    <input type="hidden" name="apo_size_type" value="<?=$app_popup_row->apo_size_type?>" />
                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_apo_view_target">
                                    <input type="hidden" name="apo_view_target" value="A" />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_ap_display_state">
                                    <?php echo get_input_radio('apo_display_yn', $this->config->item('app_popup_display_yn'), $app_popup_row->apo_display_yn, $this->config->item('app_popup_display_yn_text_color')); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_apo_content_type">
                                    <input type="hidden" name="apo_content_type" value="3" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_apo_btn_type">
                                    <input type="hidden" name="apo_btn_type" value="1" />
                        ...
                        <div class="form-group form-group-sm hidden">
                            ...
                            <div class="col-sm-10">
                                <div id="field_apo_view_page">
                                    <input type="hidden" name="apo_view_page[]" value="main" />
                                    <!--
                                    <?php
...
<script>
    ...
    $(function(){
        ...
        $(form).on('submit', function(){
            ...
            if( $("input[name='apo_content_type']").val() == '3' && $("input[name='apo_noti_content']").val() == '') {
                alert('공지사항 내용을 입력해주세요.');
                return false;
            }

            if($("input[name='apo_content_type']").val() != '3' && $('input[name="apo_image"]').val() == '' && '<?=$app_popup_row->apo_image?>' == ''){
                alert('이미지를 등록해주세요');
                return false;
            }
