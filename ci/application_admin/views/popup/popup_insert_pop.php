                    ...
                    <form name="pop_insert_form" id="pop_insert_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->insert_proc; ?>">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_division">
                                    <select name="pu_division" class="form-control" style="width:auto;">
                                        <?php echo get_select_option('', $this->config->item('popup_division'), $req['div']); ?>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_usestate">
                                    <?php echo get_input_radio('pu_usestate', $this->config->item('popup_usestate'), 'Y'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_subject">
                                    <input type="text" class="form-control" name="pu_subject" maxlength="100" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm" id="pu_target_url_wrap" style="display:none;">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_target_url">
                                    <input type="text" class="form-control" name="pu_target_url" maxlength="200" />
                                </div>
                                <p class="help-block">* 전체팝업클릭시 / 컨펌팝업 [확인] 클릭시 이동하는 URL (http(s)://play.goole.com 은 market://</p>
                        ...
                        <div class="form-group form-group-sm" id="pu_target_type_wrap" style="display:none;">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_target_type">
                                    <?php echo get_input_radio("pu_target_type", $this->config->item("popup_target_type"), "1"); ?>
                                </div>
                                <p class="help-block">* 전체팝업클릭시 / 컨펌팝업 [확인] 클릭시 이동하는 URL의 이동타입</p>
                            </div>
                        </div>
                        <div class="form-group form-group-sm" id="pu_platform_wrap" style="display:none;">
                            ...
                            <div class="col-sm-10">
                                <div id="field_pu_platform">
                                    <?php echo get_input_radio("pu_platform", $this->config->item("popup_platform"), "1"); ?>
                                </div>
                                <p class="help-inline">* 전체팝업 / 컨펌팝업일때만 동작함.</p>
                            </div>
                        </div>
                        <div class="form-group form-group-sm" id="pu_button_text_wrap" style="display:none;">
                            ...
                            <div class="col-sm-10 form-inline">
                                <div id="field_pu_button_text">
                                    <label>확인 : <input type="text" class="form-control" id="pu_button_text_confirm" name="pu_button_text_confirm" value="" /> </label>
                                    <label class="mgl10">취소 : <input type="text" class="form-control" id="pu_button_text_cancel" name="pu_button_text_cancel" value="" /></label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="field_pu_termlimit_date" style="display:none;">
                                    <div class="pull-left">
                                        <div class="input-group date" style="width:133px;">
                                            <input type="text" class="form-control" style="width:100px;" name="pu_termlimit_datetime1" value="" />
                                    ...
                                    <div class="pull-left">
                                        <div class="input-group date" style="width:133px;">
                                            <input type="text" class="form-control" style="width:100px;" name="pu_termlimit_datetime2" value="" />
                        ...
                        <div class="form-group form-group-sm">
                            <div id="field_pu_content">
                                <textarea name="pu_content" id="pu_content" style="width:100%; height:400px; visibility:hidden;"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
