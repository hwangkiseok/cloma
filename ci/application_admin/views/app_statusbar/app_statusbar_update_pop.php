            ...
            <div class="box">
                <div class="box-content">
                    <form name="pop_update_form" id="pop_update_form" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo $this->page_link->update_proc; ?>">
                        <input type="hidden" name="asb_num" value="<?php echo $app_statusbar_row->asb_num; ?>" />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_asb_color" class="input-group">
                                    ...
                                    <input type="text" name="asb_color" class="form-control" maxlength="6" value="<?php echo str_replace("#", "", $app_statusbar_row->asb_color); ?>" />
                                </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-10">
                                <div id="field_asb_usestate">
                                    <?php echo get_input_radio('asb_usestate', $this->config->item('app_statusbar_usestate'), $app_statusbar_row->asb_usestate, $this->config->item('app_statusbar_usestate_text_color')); ?>
                                </div>
                            </div>
                        </div>
                    </form>
