                ...
                <div class="box-content">
                    <form name="pop_form" id="pop_form" method="post" class="form-horizontal" role="form" action="<?php echo $this->page_link->insert_proc; ?>">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <input type="hidden" name="ksp_product_num" value="" /><!-- 상품번호 -->
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_ksp_title">
                                ...
                                <input type="text" class="form-control" name="ksp_title" maxlength="100" style="width:100%;" />
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_ksp_content">
                                <span class="input-group-addon" style="width:110px;">내용</span>
                                <textarea class="form-control" name="ksp_content" style="height:50px;"></textarea>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_ksp_button_name">
                                <span class="input-group-addon" style="width:110px;">버튼명</span>
                                <input type="text" class="form-control" name="ksp_button_name" maxlength="100" style="width:100%;" />
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <div class="input-group" style="width:100%;" id="field_ksp_display_state">
                                ...
                                <span class="form-control">
                                    <?=get_input_radio("ksp_display_state", $this->config->item("kakao_product_display_state"), "Y", $this->config->item("kakao_product_display_state_text_color"));?>
                                </span>
                            </div>
                        </div>
                    </form>
