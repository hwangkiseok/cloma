...
<div class="container-fluid">
    ...
    <form name="search_form" id="search_form" method="post" action="/offer/list_ajax" class="form-horizontal">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn" style="width:auto">
                            <select id="kfd" name="kfd" class="form-control" style="border-bottom-left-radius:3px;border-top-left-radius:3px;">
                                ...
                                <option value="offer_tb.content">댓글내용</option>
                                <option value="offer_tb.user_name">등록자명</option>
                                <option value="offer_tb.user_hp">연락처</option>
                                <option value="offer_tb.user_email">이메일</option>
    ...
    <div class="row">
        ...
        <div id="offer_list" style="position:relative;"></div>
    </div>
</div>
    ...
    $(function () {
        ...
        $('#search_form').ajaxForm({
            ...
            beforeSubmit: function(formData, jqForm, options) {
                loadingBar.show($('#offer_list'));
            },
            success: function(result) {
                $('#offer_list').html(result);
            },
            complete: function() {
                loadingBar.hide();
            }
        ...
        //ajax page
        $(document).on('click', '#offer_list .pagination.ajax a', function(e){
            e.preventDefault();
