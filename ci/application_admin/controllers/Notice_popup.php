 ...
 * APP 팝업 관리 컨트롤러 (공지)
 */
class Notice_popup extends A_Controller {
     ...
     * APP 팝업 목록
     */
    public function notice_popup_list() {
        //request
        $req = $this->_list_req();

        $this->_header();

        $this->load->view("/notice_popup/app_popup_list", array(
            'req'           => $req,
     ...
     * APP 팝업 목록 (Ajax)
     */
    public function notice_popup_list_ajax() {
        ...
        $view_file = "/notice_popup/app_popup_list_ajax";
     ...
     * APP 팝업 추가 (팝업)
     */
    public function notice_popup_insert_pop() {
        //request
        $req = $this->_list_req();
        ...
        $this->load->view("/notice_popup/app_popup_insert_pop", array(
            'req'       => $req,
     ...
     * APP 팝업 추가 처리 (Ajax)
     */
    public function notice_popup_insert_proc() {
        ajax_request_check();
...
//            $set_rules_apo_noti_subject .= "|required";
        ...
        $set_rules_array = array(
            ...
            "apo_content_type" => array("field" => "apo_content_type", "label" => "콘텐츠타입", "rules" => "required|".$this->default_set_rules),
     ...
     * APP 팝업 수정
     */
    public function notice_popup_update_pop() {
        ...
        $this->load->view("/notice_popup/app_popup_update_pop", array(
            'req'               => $req,
     ...
     * APP 팝업 수정 처리 (Ajax)
     */
    public function notice_popup_update_proc() {
        ajax_request_check();
...
//            $set_rules_apo_noti_subject .= "|required";
     ...
     * APP 팝업 삭제 처리 (Ajax)
     */
    public function notice_popup_delete_proc() {
        ajax_request_check();
     ...
     * 노출상태 변경
     */
    public function notice_popup_display_toggle() {
        ajax_request_check();
