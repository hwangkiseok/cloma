...
작 성 자 : 한햇빛
설      명
1.종성에 따른 [을,를] [이,가] [은,는] [와,과] 구분함수
2.초성검색 where절 구성
 *
 *
 * 사용법
// ,'label_JASO'   => preg_replace("/\s+/", "", $this->koreanclass->linear_hangul($v->p_name))
// ,'hash_JASO'    => preg_replace("/\s+/", "", $this->koreanclass->linear_hangul($v->p_hash))
 *
 *
****/
