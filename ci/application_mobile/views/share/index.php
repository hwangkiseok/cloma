...
<div class="box">
    <div class="box-in">
        <div class="page_tit">
            <h2> 공유상품 </h2>
            <p>고객님께서 <span>공유 하신 상품 내역</span>입니다.</p>
        </div>
    </div>
</div>
-->
...
<?if($list_count['cnt'] > 0){?>
    ...
    <?foreach ($share_prod_list as $k => $r) { //zsView($r);//$aListImage = json_decode($r['p_rep_image'],true)[0];
                ...
                <div class="sub_prod_list">
                    ...
                    <div class="cont fl">
                        <ul>
                            ...
                            <li><a class="btn btn-default wide" href="#none" onclick="go_product('<?=$r['p_num']?>','share');">상세보기</a></li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if(isApp == 'Y'){
            ...
            $('.share_wrap').css({'min-height': min_height+'px'});
        }
