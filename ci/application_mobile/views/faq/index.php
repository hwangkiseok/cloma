...
<div class="box">
    <div class="box-in">
        <div class="page_tit" style="padding-right:20px;padding-left:20px">
            <h2 style="text-align: left;"> 자주하는 질문 </h2>
            <p style="text-align: left;"><?=$this->config->item('site_name_kr')?> 에서 자주하는 질문을 안내해드립니다.</p>
        </div>
    </div>
</div>
-->
    ...
    <div class="box-in board" style="background: #f1f1f1;">
        ...
        <? if(count($faq_list) < 1 ){?>
            ...
            <div class="board_area">
                <div class="cont" style="text-align: center">등록된 자주하는 질문이 없습니다.</div>
            </div>

        <?}else{ ?>

            <? foreach ($faq_list as $r) {?>
            <div class="board_area">
                <p class="tit">
                    [<?=$this->config->item($r['bh_category'],'faq_category')?>]
                    <?=$r['bh_subject']?>
                </p>
