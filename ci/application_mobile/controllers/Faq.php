 ...
 * 자주하는 질문
 */
class Faq extends M_Controller
{
    ...
    public function index()
    {
        ...
        $faq_list = $this->board_help_model->get_board_help_list($query_data, $page_result['start'], $page_result['limit']);

        $options = array('title' => '자주하는 질문' , 'top_type' => 'back');
        $this->_header($options);

        $this->load->view('/faq/index', array(
            'req'           => $req,
