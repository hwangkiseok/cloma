...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	makePopupURL : function(){
		...
		if(this.oApp.elPlaceHolder.id == 'bq_answer_content') {
			sPopupUrl = "./sample/photo_uploader/photo_uploader_not_html5.html?id=" + this.oApp.elPlaceHolder.id;
		} else {
			sPopupUrl = "./sample/photo_uploader/photo_uploader.html?id=" + this.oApp.elPlaceHolder.id;
		}
